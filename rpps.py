...
def main():
    ...
    st.sidebar.header('Let Me Guess What Vegetable It Is')
    st.sidebar.markdown(
        " \
    ...
    image_url = st.sidebar.text_input("Please paste the image web address with jpg or jpeg format and press enter to get your prediction")
